...
namespace PayMe2
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, Guid>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser, CustomRole, Guid, CustomUserLogin, CustomUserRole, CustomUserClaim>(context.Get<Context>()));
